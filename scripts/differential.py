...
def write_markdown(path, entries, unclassified):
    ...
    lines = [
        ...
        "run rewrites it, and the page is checked for drift against the generated output.",
        "",
        ...
        "",
        "The five open-source libraries from the defect hunt are **not** among them, and",
        "the reasons are set out here rather than left to be",
